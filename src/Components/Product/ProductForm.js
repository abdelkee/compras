...
function ProductForm() {
    ...
    return (
        <div>
            <div 
                className="pt-4 space-y-4 w-4/6 fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-green-700 px-1 pb-4 rounded-xl shadow-2xl flex flex-col justify-between items-center z-50 transition-all duration-500 ease-out">
                <button 
                    onClick={() => {
                        dispatch(setFormVisibility());
                        dispatch(removeBgBlur());
